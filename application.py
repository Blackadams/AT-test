...
Token = 'EAAM6OPcHa5EBAD2VZA3TuCGaUTSo9GUbiWiejFHei2k65n9bgkoXks19RGg6bLyBBnHF4i4DvRuuvYT6jFbAnyiSThhbEZBpbD7IyIM6SQ0mcMZCjW9sxsZAu6RTHxYRxMq1yIZC2MuhMUTFZCc3TTZC0z7gZC0v8wVpYOHsNWcunGKfgYtgk4BWNucZCgG9tubcphol4tr8V733cedYJVnbL'
            ...
            if message_type == "text":
                ...
                if "test" in message:
                    ...
                    if not check_message_processed(true_id):
                        ...
                        # balance = MobileWallet.check_balance()

                        try:
                            messenger.send_message(f"Hi *{name}* enter your *pin* to the *prompt* you will receive.", mobile)
                    ...
                    if not check_message_processed(true_id):
                        ...
                        try:
                            ...
                            # messenger.send_message(f"Hi *{name.capitalize()}* recharge *{amount} KSH* to *{mobile}?", mobile)
